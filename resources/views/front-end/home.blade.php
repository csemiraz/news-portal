        ...
        <div class="row g-2">
            <div class="col-lg-8 col-md-12 left">
                <div class="inner">
                    <div class="photo">
                        <div class="bg"></div>
                        <img src="{{ asset('assets/front-end/') }}/uploads/n1.jpg" alt="">
                        <div class="text">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="inner inner-right">
                    <div class="photo">
                        <div class="bg"></div>
                        <img src="{{ asset('assets/front-end/') }}/uploads/n2.jpg" alt="">
                        <div class="text">
                            <div class="text-inner">
                                <div class="category">
                                    <span class="badge bg-success badge-sm">Politics</span>
                ...
                <div class="inner inner-right">
                    <div class="photo">
                        <div class="bg"></div>
                        <img src="{{ asset('assets/front-end/') }}/uploads/n3.jpg" alt="">
                        <div class="text">
                            <div class="text-inner">
                                <div class="category">
                                    <span class="badge bg-success badge-sm">Politics</span>
                ...
                <div class="sidebar">
                    ...
                    <div class="widget">
                        <div class="ad-sidebar">
                            <a href=""><img src="{{ asset('assets/front-end/') }}/uploads/ad-3.png" alt=""></a>
                        </div>
                    </div>
