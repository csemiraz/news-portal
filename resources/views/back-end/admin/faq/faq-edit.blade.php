                ...
                <div class="card-body">
                    <form action="{{ route('admin_faq_update', $faq->id) }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="{{ $faq->faq_title }}" name="faq_title" class="form-control">
                        </div>

                        <div class="form-group mb-3">
                            <label>FAQ Detail *</label>
                            <textarea name="faq_detail" cols="30" rows="10" class="form-control snote">{{ $faq->faq_detail }}</textarea>
                        </div>                   
